                ...
                <div className={classNames(
                    ...
                    <div className="auth-popup__top">
                        <svg className="auth-popup__top-logo" height="24" viewBox="0 0 45 24" width="45">
                            ...
                            <path d="M0 24H45V22H0V24Z" fill="#000000"/>
                        </svg>
                        {!isPWA() && (
                            <svg className="auth-popup__top-icon" onClick={onClickCloseBtn} height="28" viewBox="0 0 28 28" width="28">
                                <path d="M25.4611 28L14.009 16.5373L2.55691 28L0 25.4447L11.4701 14L0 2.55527L2.55691 0L14.009 11.4627L25.4611 0.0179953L28 2.55527L16.5479 14L28 25.4447L25.4611 28Z" fill="#000000"/>
                            </svg>
                        )}
                    </div>
