...
export default function Footer({className='footer', activePage, footerRef}) {
        ...
        return (
            <ul className="footer__mobile">
                <li className="footer__mobile-el">
                    <svg 
                        className={classNames(activePage === 'catalog' && "active")} 
                        fill="none"
                        height="40" 
                    ...
                    <svg 
                        className={classNames(activePage === 'favorites' && "active")} 
                        fill="none"
                        height="40" 
                        viewBox="0 0 45 40" 
                        width="45" 
                ...
                <li className="footer__mobile-el">
                    <svg 
                        className={classNames(activePage === 'cart' && "active")} 
                        fill="none"
                        height="40" 
                        viewBox="0 0 40 40" 
                        width="40" 
    ...
    return (
        <footer className={classNames(className, isPWA() && "footer--mobile")} ref={footerRef}>
            <div className={classNames("footer__wrapper", isPWA() && "footer__wrapper--mobile")}>
                {!isPWA() ? (
                    <>
                        <div className="footer__top">
                            ...
                            <div className="footer__top-block footer-block footer-block--last">
                                ...
                                <button className="footer-block__btn btn">
                                    <Link to='https://t.me/pero_nn_bot'>Задать вопрос</Link>
                                </button>
                            </div>
                        </div>
