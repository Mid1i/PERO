...
export default function Sneaker({brand, color, description, id, images, name, male, preview, price, sizes}) {
    const {cartItems, isInFavorites, onAddToFavorites, onAddToCart, setIsMale} = useContext(appContext);
    ...
    const settings = {
        arrows: true,
        className: "product-left__images-slider images-slider",
        dots: false,
        easing: 'linear',
        infinite: true,
        variableWidth: true,
            ...
            <div className="content__product product">
                <div className="product__top">
                    <div className="product__top-left product-left">
                        ...
                        <span className="product-left__heart" onClick={() => onAddToFavorites(id)}>
                            <svg className={classNames("product-left__heart-icon", isInFavorites(id) && "liked")} height="20" viewBox="0 0 20 20" width="20">
