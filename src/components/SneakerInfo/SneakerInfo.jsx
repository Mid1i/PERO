...
export default function Sneaker({brand, color, description, id, images, name, male, preview, price, sizes}) {
    const {cartItems, isInFavorite, onAddToFavorite, onAddToCart, setIsMale} = useContext(appContext);
            ...
            <div className="content__product product">
                <div className="product__top">
                    <div className="product__top-left product-left">
                        ...
                        <span className="product-left__heart" onClick={() => onAddToFavorite(id)}>
                            <svg className={classNames("product-left__heart-icon", isInFavorite(id) && "liked")} height="20" viewBox="0 0 20 20" width="20">
